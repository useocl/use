...
-- open examples/Others/CarRental/CarRental3.use

-- Creates the object diagram:
-- read examples/Others/CarRental/CarRental3.cmd
...
-- Date
!create r1:Rental
!set r1.fromDate := Date(1, 4, 2023)
!set r1.untilDate := Date(30, 4, 2023)

!create r2:Rental
!set r2.fromDate := Date(15, 3, 2023)
!set r2.untilDate := Date(15, 4, 2023)
