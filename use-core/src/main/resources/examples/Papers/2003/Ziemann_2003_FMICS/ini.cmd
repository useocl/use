...
-- read examples/Papers/2003/Ziemann_2003_FMICS/ini.cmd
...
!create Seg_12300 : Segment
!create Gate_12369 : Gate
!create Seg_12369 : Segment
!create Seg_12969 : Segment
...
!insert (Seg_11900,Seg_12300) into SegmentOrder
!insert (Seg_12300,Seg_12369) into SegmentOrder
!insert (Gate_12369,Seg_12300) into Boundary
!insert (Seg_12369,Seg_12969) into SegmentOrder
!insert (Seg_12969,Seg_13100) into SegmentOrder
...
!insert (Seg_29025,Seg_29535) into SegmentOrder
!insert (Seg_29535,Seg_29835) into SegmentOrder
...
!insert (Seg_12300,track1) into BelongsTo
!insert (Seg_12369,track1) into BelongsTo
!insert (Seg_12969,track1) into BelongsTo
...
!insert (Seg_29535,track1) into BelongsTo
...
!set Seg_11900.segEnd := 12300
!set Seg_11900.length := 400
!set Seg_11900.civilSpeed := 80
!set Seg_11900.grade := -3.5
!set Seg_11900.exposure := #open

!set Seg_12300.segBegin := 12300
!set Seg_12300.segEnd := 12369
!set Seg_12300.length := 69
!set Seg_12300.civilSpeed := 80
-- transition:
!set Seg_12300.grade := -3.04
!set Seg_12300.exposure := #open

!set Gate_12369.open := true

-- added:
!set Seg_12369.segBegin := 12369
!set Seg_12369.segEnd := 12969
!set Seg_12369.length := 600
!set Seg_12369.civilSpeed := 80
-- transition:
!set Seg_12369.grade := -3.04
!set Seg_12369.exposure := #open

!set Seg_12969.segBegin := 12969
!set Seg_12969.segEnd := 13100
!set Seg_12969.length := 131
!set Seg_12969.civilSpeed := 80
-- transition:
!set Seg_12969.grade := -2.58
!set Seg_12969.exposure := #open
...
!set Seg_29025.segEnd := 29535
!set Seg_29025.length := 510
!set Seg_29025.civilSpeed := 63
!set Seg_29025.grade := 0.55
!set Seg_29025.exposure := #tunnel

-- added:
!set Seg_29535.segBegin := 29535
!set Seg_29535.segEnd := 29835
!set Seg_29535.length := 300
!set Seg_29535.civilSpeed := 63
!set Seg_29535.grade := 0.55
!set Seg_29535.exposure := #tunnel
