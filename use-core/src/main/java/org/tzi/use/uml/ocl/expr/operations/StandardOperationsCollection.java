...
final class Op_collection_size extends OpGeneric {
    ...
    public Op_collection_size() {
        setParamInfo(new ParamInfo(List.of(param -> param.isKindOfCollection(VoidHandling.EXCLUDE_VOID)), List.of("Collection(T1)"), List.of("self")));
    }

    public Type matches(Type params[]) {
        return (match(params)) ? TypeFactory.mkInteger() : null;
    }
...
final class Op_collection_includes extends OpGeneric {
    ...
    public Op_collection_includes() {
        setParamInfo(new ParamInfo(List.of(param -> param.isKindOfCollection(VoidHandling.EXCLUDE_VOID), param -> true), List.of("Collection(T1)", "T2"), List.of("self", "element")));
    }
...
final class Op_collection_includesAll extends OpGeneric {
    ...
    public Op_collection_includesAll() {
        setParamInfo(new ParamInfo(List.of(param -> param.isKindOfCollection(VoidHandling.EXCLUDE_VOID), param -> param.isKindOfCollection(VoidHandling.EXCLUDE_VOID)), List.of("Collection(T1)", "Collection(T2)"), List.of("self", "other")));
    }
...
final class Op_collection_excludesAll extends OpGeneric {
    ...
    public Op_collection_excludesAll() {
        setParamInfo(new ParamInfo(List.of(param -> param.isKindOfCollection(VoidHandling.EXCLUDE_VOID), param -> param.isKindOfCollection(VoidHandling.EXCLUDE_VOID)), List.of("Collection(T1)", "Collection(T2)"), List.of("self", "other")));
    }
...
final class Op_collection_isEmpty extends OpGeneric {
    ...
    public Op_collection_isEmpty() {
        setParamInfo(new ParamInfo(List.of(param -> param.isKindOfCollection(VoidHandling.EXCLUDE_VOID)), List.of("Collection(T1)"), List.of("self")));
    }

    public Type matches(Type params[]) {
        return (match(params)) ? TypeFactory.mkBoolean() : null;
    }
...
final class Op_collection_flatten extends OpGeneric {
    ...
    public Op_collection_flatten() {
        setParamInfo(new ParamInfo(List.of(param -> param.isKindOfCollection(VoidHandling.EXCLUDE_VOID)), List.of("Collection(Collection(T1))"), List.of("self")));
    }
...
final class Op_collection_asSequence extends OpGeneric {
    ...
    public Op_collection_asSequence() {
        setParamInfo(new ParamInfo(List.of(param -> param.isKindOfCollection(VoidHandling.EXCLUDE_VOID)), List.of("Collection(T1)"), List.of("self")));
    }
...
final class Op_collection_asOrderedSet extends OpGeneric {
    ...
    public Op_collection_asOrderedSet() {
        setParamInfo(new ParamInfo(List.of(param -> param.isKindOfCollection(VoidHandling.EXCLUDE_VOID)), List.of("Collection(T1)"), List.of("self")));
    }
