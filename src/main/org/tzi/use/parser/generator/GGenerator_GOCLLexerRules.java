// $ANTLR 3.1b1 GOCLLexerRules.g 2009-03-27 15:04:24
...
public class GGenerator_GOCLLexerRules extends Lexer {
    ...
    // delegates
    // delegators
    public GGeneratorLexer gGGenerator;

    public GGenerator_GOCLLexerRules() {;} 
    public GGenerator_GOCLLexerRules(CharStream input, GGeneratorLexer gGGenerator) {
        this(input, new RecognizerSharedState(), gGGenerator);
    }
    public GGenerator_GOCLLexerRules(CharStream input, RecognizerSharedState state, GGeneratorLexer gGGenerator) {
        super(input,state);
