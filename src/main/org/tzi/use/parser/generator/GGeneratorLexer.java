// $ANTLR 2.7.4: "expandedgenerator.g" -> "GGeneratorLexer.java"$
...
public class GGeneratorLexer extends antlr.CharScanner implements GGeneratorLexerTokenTypes, TokenStream
 {
...
public GGeneratorLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public GGeneratorLexer(Reader in) {
	this(new CharBuffer(in));
}
public GGeneratorLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public GGeneratorLexer(LexerSharedInputState state) {
	super(state);
	...
	literals.put(new ANTLRHashString("between", this), new Integer(70));
	literals.put(new ANTLRHashString("Sequence", this), new Integer(51));
	literals.put(new ANTLRHashString("while", this), new Integer(92));
	literals.put(new ANTLRHashString("delete", this), new Integer(89));
	literals.put(new ANTLRHashString("endif", this), new Integer(43));
	literals.put(new ANTLRHashString("operations", this), new Integer(66));
	literals.put(new ANTLRHashString("end", this), new Integer(67));
	literals.put(new ANTLRHashString("destroy", this), new Integer(91));
	literals.put(new ANTLRHashString("insert", this), new Integer(87));
	...
	literals.put(new ANTLRHashString("association", this), new Integer(74));
	literals.put(new ANTLRHashString("post", this), new Integer(80));
	...
	literals.put(new ANTLRHashString("context", this), new Integer(77));
	literals.put(new ANTLRHashString("var", this), new Integer(81));
	literals.put(new ANTLRHashString("from", this), new Integer(90));
	literals.put(new ANTLRHashString("ordered", this), new Integer(76));
	literals.put(new ANTLRHashString("class", this), new Integer(64));
	...
	literals.put(new ANTLRHashString("model", this), new Integer(60));
	literals.put(new ANTLRHashString("role", this), new Integer(75));
	literals.put(new ANTLRHashString("Set", this), new Integer(50));
	literals.put(new ANTLRHashString("implies", this), new Integer(12));
	literals.put(new ANTLRHashString("inv", this), new Integer(78));
	literals.put(new ANTLRHashString("or", this), new Integer(13));
	literals.put(new ANTLRHashString("create", this), new Integer(85));
	literals.put(new ANTLRHashString("if", this), new Integer(40));
	literals.put(new ANTLRHashString("xor", this), new Integer(14));
	literals.put(new ANTLRHashString("associationClass", this), new Integer(68));
	...
	literals.put(new ANTLRHashString("enum", this), new Integer(62));
	literals.put(new ANTLRHashString("declare", this), new Integer(82));
	literals.put(new ANTLRHashString("constraints", this), new Integer(61));
	literals.put(new ANTLRHashString("for", this), new Integer(95));
	literals.put(new ANTLRHashString("false", this), new Integer(45));
	literals.put(new ANTLRHashString("aggregation", this), new Integer(71));
	...
	literals.put(new ANTLRHashString("associationclass", this), new Integer(69));
	literals.put(new ANTLRHashString("attributes", this), new Integer(65));
	literals.put(new ANTLRHashString("begin", this), new Integer(73));
	literals.put(new ANTLRHashString("execute", this), new Integer(96));
	literals.put(new ANTLRHashString("into", this), new Integer(88));
	literals.put(new ANTLRHashString("Tuple", this), new Integer(58));
	literals.put(new ANTLRHashString("else", this), new Integer(42));
	literals.put(new ANTLRHashString("composition", this), new Integer(72));
	literals.put(new ANTLRHashString("Bag", this), new Integer(52));
	literals.put(new ANTLRHashString("namehint", this), new Integer(86));
	literals.put(new ANTLRHashString("in", this), new Integer(11));
	literals.put(new ANTLRHashString("let", this), new Integer(9));
	literals.put(new ANTLRHashString("wend", this), new Integer(94));
	literals.put(new ANTLRHashString("procedure", this), new Integer(97));
		...
		try {      // for error handling
			...
			do {
				if (((LA(1) >= '0' && LA(1) <= '9'))) {
					...
					if ( _cnt270>=1 ) { break _loop270; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
