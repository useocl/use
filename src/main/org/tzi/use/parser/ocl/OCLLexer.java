// $ANTLR 3.1.3 Mar 18, 2009 10:09:25 OCL.g 2009-11-16 16:45:53
...
@SuppressWarnings("all") public class OCLLexer extends Lexer {
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // OCL.g:678:3: ( ( ' ' | '\\t' | '\\f' | NEWLINE ) )
            // OCL.g:679:5: ( ' ' | '\\t' | '\\f' | NEWLINE )
            {
            // OCL.g:679:5: ( ' ' | '\\t' | '\\f' | NEWLINE )
            int alt1=4;
            switch ( input.LA(1) ) {
    ...
    public final void mML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // OCL.g:695:11: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // OCL.g:696:5: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); if (state.failed) return ;

            // OCL.g:696:10: ( options {greedy=false; } : . )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mREAL() throws RecognitionException {
        try {
            // OCL.g:737:5: ( INT ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT ) )
            // OCL.g:738:5: INT ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT )
            {
            mINT(); if (state.failed) return ;
            // OCL.g:738:9: ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // OCL.g:738:10: '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )?
                    {
                    match('.'); if (state.failed) return ;
                    mINT(); if (state.failed) return ;
                    // OCL.g:738:18: ( ( 'e' | 'E' ) ( '+' | '-' )? INT )?
                    int alt8=2;
    ...
    public final void mRANGE_OR_INT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // OCL.g:741:13: ( ( INT '..' )=> INT | ( REAL )=> REAL | INT )
            int alt11=3;
    ...
    public final void mESC() throws RecognitionException {
        try {
            // OCL.g:762:1: ( '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? ) )
            // OCL.g:763:5: '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? )
            {
            match('\\'); if (state.failed) return ;
            // OCL.g:764:6: ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? )
            int alt16=11;
            switch ( input.LA(1) ) {
            case 'n':
                {
            ...
            switch (alt16) {
                ...
                case 8 :
                    ...
                    break;
                case 9 :
                    // OCL.g:772:8: 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
                    {
                    ...
                    break;
                case 10 :
                    // OCL.g:773:8: '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )?
                    {
                    matchRange('0','3'); if (state.failed) return ;
                    // OCL.g:773:17: ( '0' .. '7' ( '0' .. '7' )? )?
                    int alt14=2;
    ...
    public final void mHEX_DIGIT() throws RecognitionException {
        try {
            // OCL.g:779:10: ( ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' ) )
            // OCL.g:780:5: ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )
            {
    ...
    public final void mIDENT() throws RecognitionException {
        try {
            int _type = IDENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // OCL.g:787:6: ( ( '$' | 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // OCL.g:788:5: ( '$' | 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
    ...
    public final void mVOCAB() throws RecognitionException {
        try {
            // OCL.g:795:6: ( '\\U0003' .. '\\U0377' )
            // OCL.g:796:5: '\\U0003' .. '\\U0377'
            {
    ...
    static final String DFA18_eotS =
        ...
        "\1\uffff\1\120\3\uffff\1\123\12\uffff\1\52\1\125\2\52\1\130\1\131"+
    ...
    static final String DFA18_maxS =
        ...
        "\1\154\17\uffff\1\172\1\uffff\1\154\1\162\2\uffff\1\125\2\172\1"+
