...
public class GOCL_GOCLLexerRules extends Lexer {
    ...
    // delegates
    // delegators
    public GOCLLexer gGOCL;

    public GOCL_GOCLLexerRules() {;} 
    public GOCL_GOCLLexerRules(CharStream input, GOCLLexer gGOCL) {
        this(input, new RecognizerSharedState(), gGOCL);
    }
    public GOCL_GOCLLexerRules(CharStream input, RecognizerSharedState state, GOCLLexer gGOCL) {
        super(input,state);
