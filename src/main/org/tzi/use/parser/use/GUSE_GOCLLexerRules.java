// $ANTLR 3.1b1 GOCLLexerRules.g 2009-03-27 15:04:20
...
public class GUSE_GOCLLexerRules extends Lexer {
    ...
    // delegates
    // delegators
    public GUSELexer gGUSE;

    public GUSE_GOCLLexerRules() {;} 
    public GUSE_GOCLLexerRules(CharStream input, GUSELexer gGUSE) {
        this(input, new RecognizerSharedState(), gGUSE);
    }
    public GUSE_GOCLLexerRules(CharStream input, RecognizerSharedState state, GUSELexer gGUSE) {
        super(input,state);
