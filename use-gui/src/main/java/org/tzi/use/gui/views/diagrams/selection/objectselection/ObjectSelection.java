		...
		public void actionPerformed(ActionEvent e) {
			...
			if (org.tzi.use.gui.views.diagrams.framework.IMainWindowServices.JAVA_FX_MODE.get()){
				Platform.runLater(() -> {
					...
					org.tzi.use.gui.views.diagrams.framework.IFXWindowHost.INSTANCE.get().createNewWindow("Selection by path length",swingNode, DiagramType.SELECTED_OBJECT_PATH_VIEW);
				});
			} else {
